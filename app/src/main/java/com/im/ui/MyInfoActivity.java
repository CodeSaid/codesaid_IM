...
public class MyInfoActivity extends BaseBackActivity implements View.OnClickListener {
    ...
    private void initStatusDialog() {
        ...
        mStatusAdapter = new CommonAdapter<>(mStatusList, new CommonAdapter.onBindDataListener<String>() {
            ...
            @Override
            public void onBindViewHolder(final String model, CommonViewHolder holder, int type, int position) {
                holder.setText(R.id.tv_age_text, model);
    ...
    private void initPhotoDialog() {
        ...
        tv_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FileHelper.getInstance().toCamera(MyInfoActivity.this);
            }
        });
        tv_ablum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManager.getInstance().hide(mPhotoDialog);
                FileHelper.getInstance().toAlbum(MyInfoActivity.this);
            }
        });
    ...
    private void initAgeDialog() {
        ...
        mAgeView = mAgeDialog.findViewById(R.id.mAgeView);
        tv_age_cancel = mAgeDialog.findViewById(R.id.tv_cancel);
    ...
    private void initView() {
        ...
        ll_user_age = findViewById(R.id.ll_user_age);

        et_user_desc = findViewById(R.id.et_user_desc);

        tv_user_birthday = findViewById(R.id.tv_user_birthday);
        ll_user_birthday = findViewById(R.id.ll_user_birthday);

        tv_user_constellation = findViewById(R.id.tv_user_constellation);
        ll_user_constellation = findViewById(R.id.ll_user_constellation);

        tv_user_hobby = findViewById(R.id.tv_user_hobby);
        ll_user_hobby = findViewById(R.id.ll_user_hobby);

        tv_user_status = findViewById(R.id.tv_user_status);
        ll_user_status = findViewById(R.id.ll_user_status);
    ...
    private void loadMyInfo() {
        ...
        tv_user_sex.setText(imUser.isSex() ? getString(R.string.text_me_info_boy)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_save) {
            ...
            mLoadingView.show(getString(R.string.text_me_info_update));
    ...
    private void updateUser(IMUser user) {
        //名称不能为空
        ...
        user.setDesc(desc);
        user.setSex(sex.equals(getString(R.string.text_me_info_boy)) ? true : false);
                    ...
                    BmobManager.getInstance().fetchUserInfo(new FetchUserInfoListener<BmobUser>() {
                        ...
                        public void done(BmobUser bmobUser, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(MyInfoActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                } else {
